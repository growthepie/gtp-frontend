...
export default function EmailAuth({ onSubmit }: EmailAuthProps) {
  ...
  return (
    <div className="fixed inset-0 bg-color-bg-default flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        {/* Logo */}
        <div className="flex justify-center mb-12">
          <div className="relative h-[60px] w-[257px]">
            <svg viewBox="0 0 194 46" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M13.1032 15.2443C13.026 14.1679 13.3192 13.1795 13.9481 12.2211C14.3693 11.5839 14.9665 10.896 15.6254 10.1381C17.3254 8.18037 19.431 5.75704 19.9466 2.5459C21.0675 5.00735 20.5238 7.40073 19.2831 9.60169C18.7249 10.591 18.1068 11.3017 17.5169 11.9796C16.8226 12.7774 16.1682 13.5298 15.698 14.6362C15.4394 15.238 15.2923 15.8143 15.2233 16.3779L13.1032 15.2443Z" fill="url(#paint0_radial)" />
              <path d="M16.741 17.1918C16.9996 16.2424 17.4471 15.3548 18.0416 14.4934C18.5335 13.7746 18.9946 13.2418 19.4084 12.7635C20.8007 11.1525 21.6648 10.1523 21.4116 4.75293C21.574 5.09964 21.7347 5.43364 21.8908 5.75584L21.8917 5.75766C23.2495 8.57671 24.2025 10.5535 22.6014 13.2682C21.81 14.6096 21.2327 15.2767 20.7227 15.8667C20.1482 16.5301 19.658 17.0974 19.0418 18.4171L16.741 17.1918Z" fill="url(#paint1_radial)" />
              <path d="M22.7032 16.341C22.0787 17.0807 21.0595 18.1009 21.0132 18.168L26.7811 14.9433C26.6604 13.8687 25.868 12.6025 24.8941 10.8027C25.0911 13.1752 24.1653 14.6084 22.7032 16.341Z" fill="url(#paint2_radial)" />
              <path d="M26.7384 16.0156C26.5832 16.7036 25.7336 18.1349 25.1092 18.8782C23.136 21.2253 22.1086 22.2264 20.4205 25.758C20.3252 25.3759 20.2253 25.0155 20.13 24.6715C19.659 22.9725 19.3694 21.5575 19.934 20.3377L26.7384 16.0156Z" fill="url(#paint3_radial)" />
              <path d="M19.1191 23.9723C18.6363 22.5591 18.2896 21.3774 18.5419 19.8826L16.5252 18.5684C16.4135 20.7675 17.3529 23.3352 19.9469 26.6407C19.8089 25.822 19.395 24.7801 19.1191 23.9723Z" fill="url(#paint4_radial)" />
              <path d="M15.1809 17.6928C15.2154 18.408 15.6574 20.2986 16.0532 21.2988C14.9241 19.8584 13.6897 17.6484 13.3367 16.4902L15.1809 17.6928Z" fill="url(#paint5_radial)" />
              <path d="M38.9341 28.4409C38.9341 25.1689 32.8494 22.417 24.6264 21.6465C23.8423 22.5269 23.0581 23.6196 22.3084 25.2307L21.1793 27.3753C20.9642 27.7711 20.5676 28.0306 20.1274 28.0651C19.6799 28.0996 19.2488 27.9036 18.982 27.5451L18.2577 26.5721C16.7493 24.6462 15.6456 23.1205 14.7752 21.6928C6.79455 22.5232 0.934082 25.2316 0.934082 28.4409C0.934082 32.31 9.44932 35.4513 19.9386 35.4513C20.4451 35.4513 20.9479 35.444 21.4453 35.4295L22.9846 31.0721L22.9973 31.0412C23.3367 30.1926 24.1536 29.6371 25.0621 29.6244H25.0685L38.6582 29.6607C38.7979 29.3185 38.9341 28.7976 38.9341 28.4409Z" fill="url(#paint6_radial)" />
              <path d="M25.6228 35.5455H36.27L35.8044 36.7263H25.2135L22.8555 43.4527V36.3097L24.5046 31.6437C24.5981 31.4077 24.8268 31.2507 25.0837 31.2471L37.9899 31.2507L37.5125 32.4143H26.7382L26.4079 33.3963H37.144L36.634 34.5635H25.9958L25.6228 35.5455Z" fill="url(#paint7_radial)" />
              <path d="M1.58765 31.5332C2.81383 35.0003 5.81441 39.0728 6.45246 39.6682C8.65615 41.7439 15.7564 43.4529 21.3482 43.4529V37.6088C11.6549 37.6088 4.08722 34.4693 1.58765 31.5332Z" fill="url(#paint8_radial)" />
              ...
              <defs>
                <radialGradient id="paint0_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(19.1535 6.84238) rotate(117.912) scale(11.808 9.11336)">
                  <stop stopColor="rgb(var(--accent-turquoise))" />
                  <stop offset="1" stopColor="rgb(var(--accent-petrol))" />
                </radialGradient>
                <radialGradient id="paint1_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(22.1799 8.99725) rotate(115.692) scale(11.4385 8.3377)">
                  <stop stopColor="rgb(var(--accent-turquoise))" />
                  <stop offset="1" stopColor="rgb(var(--accent-petrol))" />
                </radialGradient>
                <radialGradient id="paint2_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(25.6971 13.0905) rotate(127.548) scale(7.00774 6.31751)">
                  <stop stopColor="rgb(var(--accent-turquoise))" />
                  <stop offset="1" stopColor="rgb(var(--accent-petrol))" />
                </radialGradient>
                <radialGradient id="paint3_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(25.4013 19.0418) rotate(125.634) scale(9.04236 7.98874)">
                  <stop stopColor="rgb(var(--accent-turquoise))" />
                  <stop offset="1" stopColor="rgb(var(--accent-petrol))" />
                </radialGradient>
                <radialGradient id="paint4_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(19.3022 21.0758) rotate(112.642) scale(6.59793 4.37388)">
                  <stop stopColor="rgb(var(--accent-turquoise))" />
                  <stop offset="1" stopColor="rgb(var(--accent-petrol))" />
                </radialGradient>
                <radialGradient id="paint5_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(15.5427 17.9839) rotate(119.008) scale(4.14768 3.28196)">
                  <stop stopColor="rgb(var(--accent-turquoise))" />
                  <stop offset="1" stopColor="rgb(var(--accent-petrol))" />
                </radialGradient>
                <radialGradient id="paint6_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(31.793 25.9345) rotate(159.689) scale(30.0014 18.2218)">
                  <stop stopColor="#FFDF27" />
                  <stop offset="0.9999" stopColor="#FE5468" />
                </radialGradient>
                <radialGradient id="paint7_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(35.1458 35.0383) rotate(140.592) scale(14.5034 13.2732)">
                  <stop stopColor="rgb(var(--accent-turquoise))" />
                  <stop offset="0.9999" stopColor="rgb(var(--accent-petrol))" />
                </radialGradient>
                <radialGradient id="paint8_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(17.6347 35.2357) rotate(148.427) scale(17.1733 14.2932)">
                  <stop stopColor="rgb(var(--accent-turquoise))" />
                  <stop offset="0.9999" stopColor="rgb(var(--accent-petrol))" />
                </radialGradient>
              </defs>
        ...
        {/* Auth Card */}
        <div className="bg-color-bg-medium rounded-3xl p-8 shadow-card-dark">
          {!success ? (
            <>
              <h1 className="text-2xl font-bold text-color-text-primary text-center mb-2">
                Welcome to Growth{'\u2022'}The{'\u2022'}Pie
              </h1>
              <p className="text-color-text-secondary text-center mb-8">
                This is a protected preview. Please enter your email to continue.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <input
                    ...
                    className="w-full px-4 py-3 bg-color-bg-default border border-color-border-primary rounded-full text-color-text-primary placeholder-color-text-tertiary focus:outline-none focus:border-color-accent-primary focus:ring-1 focus:ring-color-accent-primary"
                    disabled={isLoading}
                    autoFocus
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-3 bg-gradient-to-r from-[#FE5468] to-[#FFDF27] text-black font-semibold rounded-full hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-color-text-tertiary text-sm mt-4">
                Click the link in your email to access the platform.
              ...
              <button
                ...
                className="mt-6 text-color-accent-primary hover:underline"
              >
