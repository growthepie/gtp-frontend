...
type VerticalVirtuosoScrollContainer = {
  className?: string;
...
export default forwardRef(function VerticalVirtuosoScrollContainer(
  {
    // children,
    className,
    height,
  ...
  }, [totalCount, contentHeight, contentScrollAreaHeight, contentScrollAreaRef]);
      ...
      >
        ...
        <div className={`overflow-y-visible w-full ${contentOrder}`}>
          <Virtuoso
            ...
            scrollerRef={mergeRefs([contentScrollAreaRef, ref])}
            style={{
              height: `${height}px`,
