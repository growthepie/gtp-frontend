          ...
          <GTPButtonRow style={{ width: isMobile ? "100%" : "auto" }}>
            <Tooltip placement="bottom" allowInteract>
              <TooltipTrigger asChild>
                <div>
                  <GTPButton
                    label={isLessThan2xl ? (focusEnabled ? "L2 Ecosystem" : "ETH Ecosystem") : (focusEnabled ? "Layer 2 Ecosystem" : "Total Ethereum Ecosystem")}
                    rightIcon={"gtp-metrics-ethereum-ecosystem" as GTPIconName}
                    variant="primary"
                    size="sm"
                    isSelected={showTotalUsers}
                    clickHandler={() => {
              ...
              <TooltipContent>
                <div className="p-[15px] bg-color-bg-default rounded-[15px] shadow-standard flex flex-col gap-y-[5px] max-w-[300px] sm:max-w-[400px]">
                  ...
                  <div className="text-xs text-left">
                    The total number of unique addresses interacting with one or multiple chains in the Ethereum ecosystem in a given week. When &quot;Total Ecosystem&quot; is toggled on you can see the number of addresses that are active only on Ethereum Mainnet in blue.
                  </div>
                </div>
              </TooltipContent>
            </Tooltip>
            <Tooltip placement="bottom" allowInteract>
              <TooltipTrigger asChild>
                <div>
                  <GTPButton
                    label="Composition"
                    rightIcon={"gtp-metrics-chaincomposition" as GTPIconName}
                    variant="primary"
                    size="sm"
                    isSelected={"absolute" === selectedScale && !showTotalUsers}
                    clickHandler={() => {
              ...
              <TooltipContent>
                <div className="p-[15px] bg-color-bg-default rounded-[15px] shadow-standard flex flex-col gap-y-[5px] max-w-[300px] sm:max-w-[420px]">
                  <div className="flex items-center gap-x-[10px]">
            ...
            <Tooltip placement="bottom" allowInteract>
              <TooltipTrigger asChild>
                <div>
                  <GTPButton
                    label={isLessThan2xl ? "Comp. Split" : "Composition Split"}
                    rightIcon={"gtp-metrics-chains-percentage" as GTPIconName}
                    variant="primary"
                    size="sm"
          ...
          <GTPButtonRow style={{ width: isMobile ? "100%" : "auto" }}>
            {!zoomed ? (
              Object.keys(timespans).map((timespan) => (
                <GTPButton
                  key={timespan}
                  label={isMobile ? timespans[timespan].labelShort : timespans[timespan].label}
                  variant="primary"
                  size="sm"
                  isSelected={selectedTimespan === timespan}
              ...
              <>
                <GTPButton
                  ...
                  variant="highlight"
                  size="sm"
                  clickHandler={() => setZoomed(false)}
                />
                <GTPButton
                  label={intervalShown?.label ?? ""}
                  variant="primary"
                  size="sm"
                  isSelected={true}
                />
