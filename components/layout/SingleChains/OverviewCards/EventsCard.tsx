...
export default function EventsCard({ children, totalHeight, customTitleArea, minHeight, tooltipContent, isHidden, topCard = false }: EventsCardProps) {
    ...
    <>
      ...
      <div
        ...
        className={`w-full h-full transition-height duration-300 flex-1 ${topCard ? "absolute " : "relative"} ${isHidden ? "hidden" : ""}`}
      ...
      >
            ...
            >
                ...
                >
                    <GTPIcon icon="in-button-down-monochrome" size="md" className={`text-color-text-secondary transition-all duration-300 ${expanded ? "rotate-180" : ""}`} />
