...
export default function DAHeadCharts({selectedTimespan, timespans, data}: {selectedTimespan: string, timespans: any, data: AllDAOverview}) {
    ...
    return (
        ...
        {Object.keys(data.metrics)
            ...
            <div className="relative flex flex-col w-full overflow-hidden h-[232px] bg-[#1F2726] rounded-2xl  group " key={metricKey}>
                ...
                <div className="absolute text-[18px] top-[16px] right-[30px] numbers">
                ...
                <hr className="absolute w-full border-t-[2px] top-[110px] border-[#5A64624F] my-4" />
                <hr className="absolute w-full border-t-[2px] top-[169px] border-[#5A64624F] my-4" />
