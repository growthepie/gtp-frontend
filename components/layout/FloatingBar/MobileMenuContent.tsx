...
export default function MobileMenuContent({ onClose }: MobileMenuContentProps) {
  ...
  useEffect(() => {
    const calculateHeight = () => {
      if (containerRef.current && headerRef.current && footerRef.current) {
        ...
        const navItemsVerticalMargins = 40; // e.g., 20px margin-top + 20px margin-bottom for the nav list
  ...
  return (
    <div 
      ref={containerRef} 
      className="flex flex-col h-[calc(100dvh-120px)] w-[calc(100vw-40px)] max-w-sm"
    >
      ...
      {/* Navigation Items */}
      <div className="mt-[20px] mb-[20px] flex-grow overflow-hidden pl-[20px] pr-[5px]">
        {scrollableHeight > 0 && (
      ...
      {/* Footer */}
      <div ref={footerRef} className="p-[20px] pt-0 mt-auto">
        <div className="flex flex-col justify-end pt-3 pb-0 relative">
          ...
          <div className="items-end justify-center flex space-x-[15px] mt-[2px] mb-[5px]">
