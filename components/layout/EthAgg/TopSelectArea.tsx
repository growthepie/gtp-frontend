  ...
  return (
    <Container style={{marginTop: "45px"}}>
        <div className="h-full w-full relative">
            ...
            <div className="absolute bottom-[2px] left-0 w-full h-[24px] z-[-1] bg-[#1F2726] rounded-full mr-[10px]"></div>
        </div>
    </Container>
  );
}
...
const ComingSoonButton = ( {
    ...
    return (
        <div className={`flex ${selectedBreakdownGroup === breakdownGroup && "flex-1"} items-center justify-between flex-row gap-x-[15px] rounded-full px-[10px] py-[3px] transition-all text-[#344240]
...
const SelectionButton = ({
    ...
    return (
        <div className={`flex ${selectedBreakdownGroup === breakdownGroup && "flex-1"} justify-start flex-row gap-x-[15px] rounded-full px-[10px] py-[3px] transition-all cursor-pointer
            ${selectedBreakdownGroup === breakdownGroup ? "bg-active-black border-[3px] border-[#344240] h-[44px]" 
        ...
        >   
            <div className={`flex items-center gap-x-[15px] ${isHovered || selectedBreakdownGroup === breakdownGroup ? "scale-[122%]" : "scale-100"} origin-left transition-all text-nowrap`}>
                <GTPIcon icon={icon} size="md" className={`transition-all relative ${breakdownGroup === "Builders & Apps" ? "bottom-[2px]" : ""}`}/>
