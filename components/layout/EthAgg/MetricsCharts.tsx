  ...
  const chartConfigs = useMemo(() => {
    ...
    return {
      appRevenue: {
        ...
        tooltipContent: "Application Revenue is the total revenue generated by applications built on Ethereum. A 7-day rolling average is applied to the chart. Source: DefiLlama, growthepie",
        prefix,
        urlKey: "app-revenue",
        seriesConfigs: [
          {
      ...
      tps: {
        title: "Daily TPS",
        tooltipContent: "Daily average transactions-per-second (TPS) across the Ethereum ecosystem. A 7-day rolling average is applied to the chart. Source: growthepie",
        prefix: "",
        seriesConfigs: [
          {
            name: "Ethereum Mainnet",
      ...
      <Container className='flex flex-col gap-y-[60px] pt-[60px] w-full z-0'>
        <div className='flex flex-col gap-y-[15px]'>
          ...
          <div className='flex flex-col xl:flex-row gap-[15px] w-full'>
            <AggChart dataSource={chartData.appData} {...chartConfigs.appRevenue} urlKey="app-revenue" chartKey="appRevenue" onCoordinatesUpdate={handleCoordinatesUpdate} allChartCoordinates={chartCoordinates} />
            <AggChart dataSource={chartData.stableData} {...chartConfigs.stablecoin} urlKey="stablecoin-market-cap" chartKey="stablecoin" onCoordinatesUpdate={handleCoordinatesUpdate} allChartCoordinates={chartCoordinates} />
          </div>
        </div>
        <div className='flex flex-col gap-y-[15px]'>
          <div className='flex gap-x-[8px] items-center'>
