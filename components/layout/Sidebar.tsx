              ...
              <div className="fixed inset-0 p-[20px] z-50 flex flex-col justify-items-start select-none overflow-hidden">
                <div className="flex justify-between space-x-[20px] items-end w-full pointer-events-auto">
                  ...
                  <div className="flex space-x-[20px] items-end">
                    <div className="z-50 flex items-center space-x-[16px] mb-0.5 w-full px-2">
                      <Link
                ...
                <div className="z-50 mt-[30px] h-[calc(100vh-100px)] w-full flex flex-col justify-between overflow-hidden relative pointer-events-auto">
                  ...
                  <div className="flex flex-col justify-end pt-3 pb-6 relative mb-[17px] pointer-events-auto">
                    ...
                    <div className="items-end justify-center z-50 flex space-x-[15px] mt-[2px] mb-[17px]">
                      <DarkModeSwitch isMobile />
                      <EthUsdSwitch isMobile />
                    </div>
                  </div>
                  <div className="mt-24 w-full text-center py-6 absolute bottom-0">
                    <div className="text-[0.7rem] text-inherit leading-[2] z-50">
