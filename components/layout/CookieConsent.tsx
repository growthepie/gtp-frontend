...
export default function CookieConsent() {
  ...
  return (
    <div
      className={`flex md:flex-col flex-col-reverse items-center justify-between lg:space-y-0 lg:space-x-8 bg-forest-50 dark:bg-[#5A6462CC] text-base text-forest-900 dark:text-forest-50 border-forest-600 border-[0.5px] bottom-0 mb-10 p-[15px] fixed z-50 w-[90%] sm:w-9/12 max-w-[884px] mx-auto rounded-3xl lg:rounded-[34px] left-[50%] transform -translate-x-1/2 shadow-2xl shadow-black/70 ${
        consent ? "hidden" : ""
      }`}
    >
