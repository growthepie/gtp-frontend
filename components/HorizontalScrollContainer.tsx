  ...
  return (
    <div className={`w-full px-0 overflow-x-hidden ${className}`}>
      <div className="overflow-x-visible ">
        <div className="pl-[20px] md:pl-[64px] relative overflow-x-scroll scrollbar-none max-w-full" ref={contentSrollAreaRef}>

          <div className={showScroller ? "mr-[20px] md:mr-[64px]" : ''}>
            <div className="min-w-fit w-full max-w-full pr-[20px] md:pr-[64px]" ref={contentRef} >
              <div>{children}</div>
            </div>
          </div>
        </div>
