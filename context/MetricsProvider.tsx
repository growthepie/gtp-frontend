...
const APIEndpoints: {
	...
	chains: {
		Arbitrum: 'https://d2cfnw27176mbd.cloudfront.net/v1/chains/arbitrum.json',
		Optimism: 'https://d2cfnw27176mbd.cloudfront.net/v1/chains/optimism.json',
	},
	metrics: {
		TxCount: 'https://d2cfnw27176mbd.cloudfront.net/v1/metrics/txcount.json',
		TVL: 'https://d2cfnw27176mbd.cloudfront.net/v1/metrics/tvl.json',
	},
};
...
export const MetricsProvider = ({
	...
	useEffect(() => {
		...
		const endpointCount =
			_.size(APIEndpoints.chains) + _.size(APIEndpoints.metrics);
