    ...
    >
      ...
      <body className="bg-forest-50 dark:bg-[#1F2726] text-forest-900 dark:text-forest-500 font-raleway overflow-x-hidden overflow-y-scroll">
        ...
        <Providers>
          ...
          {/* <div className="fixed bottom-0 right-0 left-0 flex justify-center items-center z-50">
            <div className="flex w-full max-w-[1680px] justify-end items-center p-[20px] md:pb-[20px] md:pr-[50px]">
