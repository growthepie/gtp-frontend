  ...
  const EpochStatus = useMemo(() => {
    if (summaryData) {
      ...
      for (let epoch in epochsInfo) {
        ...
        let epochAllocationStart = new Date(epochsInfo[epoch].allocationStart).getTime() / 1000;
        let epochAllocationEnd = new Date(epochsInfo[epoch].allocationEnd).getTime() / 1000;

        // check if the current time is between the start and end of the epoch
        if (currentTime >= epochAllocationStart && currentTime <= epochAllocationEnd) {
          ...
          return (
            <>
              <div className="text-[9px]">Epoch {currentEpoch.epoch} Allocation ends in</div>
      ...
      let epochAllocationStart = new Date(currentEpoch.allocationStart).getTime() / 1000;
                      ...
                      <div className="bg-forest-1000 rounded-full flex items-center justify-center w-[26px] h-[26px]">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <g clipPath="url(#clip0_12402_20306)">
                            ...
                            <path fillRule="evenodd" clipRule="evenodd" d="M0.884698 5.45315C1.07121 5.19887 1.48379 5.11198 1.80622 5.25907L7.35645 7.79111L12.9067 5.25907C13.2291 5.11198 13.6417 5.19887 13.8282 5.45315C14.0147 5.70744 13.9045 6.03282 13.5821 6.17991L7.69416 8.86602C7.48523 8.96133 7.22766 8.96133 7.01873 8.86602L1.13079 6.17991C0.808366 6.03282 0.698185 5.70744 0.884698 5.45315Z" fill="url(#paint1_linear_12402_20306)" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M7.35645 8C7.87421 8 8.29395 8.46875 8.29395 8.9375V13.625C8.29395 14.0938 7.87421 14.5625 7.35645 14.5625C6.83868 14.5625 6.41895 14.0938 6.41895 13.625V8.9375C6.41895 8.46875 6.83868 8 7.35645 8Z" fill="url(#paint2_linear_12402_20306)" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M11.5752 11.75C12.3518 11.75 12.9814 11.1204 12.9814 10.3438C12.9814 9.5671 12.3518 8.9375 11.5752 8.9375C10.7985 8.9375 10.1689 9.5671 10.1689 10.3438C10.1689 11.1204 10.7985 11.75 11.5752 11.75ZM11.5752 12.6875C12.8696 12.6875 13.9189 11.6382 13.9189 10.3438C13.9189 9.04933 12.8696 8 11.5752 8C10.2808 8 9.23145 9.04933 9.23145 10.3438C9.23145 11.6382 10.2808 12.6875 11.5752 12.6875Z" fill="url(#paint3_linear_12402_20306)" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M12.3756 11.4184C12.5586 11.2353 12.8554 11.2353 13.0385 11.4184L15.1881 13.568C15.3711 13.751 15.3711 14.0478 15.1881 14.2309C15.005 14.4139 14.7082 14.4139 14.5252 14.2309L12.3756 12.0813C12.1925 11.8982 12.1925 11.6014 12.3756 11.4184Z" fill="url(#paint4_linear_12402_20306)" />
                          </g>
                          <defs>
                        ...
                        <div className="flex w-full justify-between pt-[5px] gap-x-[5px]">
                          <div className="flex bg-[#5A6462] rounded-[11px] w-[135px] px-[13px] py-[5px] gap-x-[6px] h-[43px] items-center justify-center">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path fillRule="evenodd" clipRule="evenodd" d="M12.3604 24.5C18.9878 24.5 24.3604 19.1274 24.3604 12.5C24.3604 5.87258 18.9878 0.5 12.3604 0.5C5.73293 0.5 0.360352 5.87258 0.360352 12.5C0.360352 19.1274 5.73293 24.5 12.3604 24.5ZM7.9577 6.1C7.46334 6.1 7.06259 6.50934 7.06259 7.01429C7.06259 7.51923 7.46334 7.92857 7.9577 7.92857H16.9087C17.4031 7.92857 17.8039 7.51923 17.8039 7.01429C17.8039 6.50934 17.4031 6.1 16.9087 6.1H7.9577ZM8.8528 11.5857C8.35845 11.5857 7.9577 11.9951 7.9577 12.5C7.9577 13.0049 8.35845 13.4143 8.8528 13.4143H16.0136C16.508 13.4143 16.9087 13.0049 16.9087 12.5C16.9087 11.9951 16.508 11.5857 16.0136 11.5857H8.8528ZM7.51014 17.0714C7.01579 17.0714 6.61504 17.4808 6.61504 17.9857C6.61504 18.4907 7.01579 18.9 7.51014 18.9H17.3563C17.8507 18.9 18.2514 18.4907 18.2514 17.9857C18.2514 17.4808 17.8507 17.0714 17.3563 17.0714H7.51014Z" fill="url(#paint0_linear_11954_38557)" />
                              <defs>
