...
const FundamentalsContent = ({ metric }: FundamentalsContentProps) => {
  return (
    <>
      <MetricDataProvider metric={metric} type="fundamentals">
        <MetricChartControlsProvider type="fundamentals">
          <MetricSeriesProvider type="fundamentals">
            <PageContainer>
