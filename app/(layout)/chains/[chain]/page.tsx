          ...
          <div className="flex flex-col w-full">
            ...
            {(IS_DEVELOPMENT || IS_PREVIEW) && (
              <>
                ...
                <div className="relative grid sm:grid-rows-2 sm:grid-flow-col md:grid-rows-none md:grid-cols-[270px, auto, auto, auto, 131px] gap-x-[5px] gap-y-[5px] pb-[30px] md:pb-[60px] overflow-hidden">
                  <ChainSectionHead
                    title={"Menu"}
