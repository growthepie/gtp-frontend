...
import {
  ...
  ShrinkSecond,
} from "@/components/SkrinkPriority";
    ...
    <>
      ...
      <Container className="flex w-full pt-[30px] md:pt-[45px]">
        {master && chainFeeData && chainData && (
          <ShrinkPriorityContainer className="min-w-full">
            <ShrinkSecond className="flex w-[253px] max-w-[253px] basis-[calc(100%-35px*4)]">
              <ChainSectionHead
                title={"Menu"}
            ...
            <ShrinkFirst className="flex flex-shrink flex-grow-0 min-w-[calc(35px*4)] basis-[calc(35px*4)]">
              {/* <ShrinkPriorityContainer> */}
              <ShrinkSecond className="flex flex-grow flex-shrink-0 transition-all min-w-[calc(35px*1)] hover:min-w-[800px]">
                <ChainSectionHead
                  title={"Background"}
              ...
              <ShrinkFirst className="flex flex-shrink flex-grow-0 min-w-[calc(35px*3)] basis-[calc(35px*3)]">
                {/* <ShrinkPriorityContainer> */}
                <ShrinkSecond className="flex flex-grow flex-shrink-0 transition-all min-w-[calc(35px*1)] hover:min-w-[228px] basis-[calc(35px*1)] hover:basis-[228px]">
                  <ChainSectionHead
                    title={"Usage"}
                    enableDropdown={isMobile}
                ...
                <ShrinkFirst className="flex flex-shrink flex-grow-0 min-w-[calc(35px*2)] basis-[calc(35px*2)]">
                  {/* <ShrinkPriorityContainer> */}
                  <ShrinkSecond className="flex flex-grow flex-shrink-0 transition-all min-w-[calc(35px*1)] hover:min-w-[200px] basis-[calc(35px*1)] hover:basis-[200px]">
                    <ChainSectionHead
                      title={"Technology"}
                      enableDropdown={isMobile}
                      childrenHeight={isMobile ? 116 : 111}
                  ...
                  <ShrinkFirst className="flex flex-shrink flex-grow-0 transition-all min-w-[calc(35px*1)] hover:min-w-[125px] basis-[calc(35px*1)] hover:basis-[125px]">
                    <ChainSectionHead
                      title={"Risk"}
                      enableDropdown={isMobile}
                      childrenHeight={isMobile ? 116 : 111}
          ...
          <div className="flex flex-col w-full">
            ...
            <div className="relative grid lg:grid-flow-col grid-rows-none lg:grid-cols-[270px, auto, auto, auto, 131px] gap-x-[5px] gap-y-[5px] pb-[30px] md:pb-[60px] overflow-visible">
              ...
              <ChainSectionHead
                ...
                enableDropdown={isMobile}
                childrenHeight={isMobile ? 200 : 111}
                className={`min-w-[100px] flex-grow transition-all duration-300 min-w-none" lg:hover:min-w-[510px]`}
              >
                <div
                  className={`min-h-[111px] lg:max-h-[111px] relative flex flex-col justify-between transition-opacity duration-300 px-[10px] py-[10px] rounded-[15px] bg-forest-50 dark:bg-[#1F2726] overflow-hidden`}
                >
              ...
              <ChainSectionHead
                ...
                enableDropdown={isMobile}
                childrenHeight={isMobile ? 116 : 111}
                className="hover:min-w-[230px] max-w-[230px] min-w-[35px] transition-all duration-300"
              >
                <div className="flex flex-col gap-y-[5px] overflow-hidden relative ">
              ...
              <ChainSectionHead
                ...
                enableDropdown={isMobile}
                childrenHeight={isMobile ? 116 : 111}
                className={`transition-all duration-300 flex-shrink-0 hover:min-w-[126px] max-w-[126px] min-w-[35px] hidden lg:block`}
              >
                <div className="relative h-[111px] flex justify-between px-[10px] py-[10px] rounded-[15px] bg-forest-50 dark:bg-[#1F2726]  overflow-hidden">
                  <div
                    className={`absolute inset-0 pointer-events-none shadow-inner  rounded-2xl group-hover:opacity-0 transition-opacity duration-300 xl:opacity-0 lg:opacity-100`}
              ...
              <div className={` gap-x-[5px] flex lg:hidden`}>
                <ChainSectionHead
                  title={"Technology"}
                  enableDropdown={isMobile}
                  childrenHeight={isMobile ? 116 : 111}
