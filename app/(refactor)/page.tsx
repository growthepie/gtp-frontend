...
import MainPage from "@/refactor/components/layout/MainPage";
import PageTitle from "@/refactor/components/layout/PageTitle";
...
export default async function Page() {
  return (
    <MainPage>
      <PageTitle
        title="Mastering Ethereum Layer 2s"
        subtitle="Your Gateway to Curated Analytics and Knowledge"
      />
