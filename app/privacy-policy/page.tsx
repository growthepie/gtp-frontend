  ...
  return (
    <div className="py-8 px-4">
      ...
      <p className="mb-4">
        ...
        Data protection is of a particularly high priority for orbal GmbH. The
        use of the Internet pages of orbal GmbH is possible without any
      ...
      <p className="mb-4">
        ...
        orbal GmbH. By means of this data protection declaration, our enterprise
      ...
      <p className="mb-4">
        As the controller, orbal GmbH has implemented numerous technical and
      ...
      <ol type="1" className="list-decimal list-inside text-sm">
        <li>
          <strong className="mb-2">Definitions</strong>
          <p className="mb-4">
            The data protection declaration of orbal GmbH is based on the terms
          ...
          <ol type="a" className="list-[lower-alpha] list-inside ml-4">
            <li>
              <strong className="mb-2">Personal Data</strong>
              <p className="mb-4">
                ...
                identification of a particular person, also constitute personal
                data.
              </p>
            </li>
            <li>
              <strong className="mb-2">Data Subject</strong>
              <p className="mb-4">
            ...
            <li>
              <strong className="mb-2">Processing</strong>
              <p className="mb-4">
            ...
            <li>
              <strong className="mb-2">Restriction of Processing</strong>
              <p className="mb-4">
            ...
            <li>
              <strong className="mb-2">Profiling</strong>
              <p className="mb-4">
            ...
            <li>
              <strong className="mb-2">Pseudonymisation</strong>
              <p className="mb-4">
            ...
            <li>
              ...
              <p className="mb-4">
                ...
                naturalor legal person, public authority, agency or other body
            ...
            <li>
              <strong className="mb-2">Processor</strong>
              <p className="mb-4">
            ...
            <li>
              <strong className="mb-2">Recipient</strong>
              <p className="mb-4">
            ...
            <li>
              <strong className="mb-2">Third Party</strong>
              <p className="mb-4">
            ...
            <li>
              <strong className="mb-2">Consent</strong>
              <p className="mb-4">
        ...
        <li>
          <strong className="mb-2">Name and address of the controller</strong>
          <p className="mb-4">
        ...
        <li>
          ...
          <p className="mb-4">
            Through the use of cookies, orbal GmbH can provide the users of this
        ...
        <li>
          ...
          <p className="mb-4">
            The website of orbal GmbH collects a series of general data and
            ...
            the event of attacks on our information technology systems. When
            using these general data and information, orbal GmbH does not draw
            ...
            in case of a cyber-attack. Therefore, orbal GmbH analyzes
        ...
        <li>
          <strong className="mb-2">
            Subscription to our newsletter / registering interest
          </strong>
          <p className="mb-4">
            On the website of orbal GmbH, users are given the opportunity to
            ...
            as when the newsletter is ordered from the controller. orbal GmbH
            ...
            receive the newsletter. During the registration for the newsletter,
            we also store the IP address of the computer system assigned by the
            Internet service provider (ISP) and used by the data subject at the
            time of the registration, as well as the date and time of the
            registration. The collection of this data is necessary in order to
            understand the (possible) misuse of the e-mail address of a data
            subject at a later date, and it therefore serves the aim of the
            legal protection of the controller. The personal data collected as
            ...
            offer, or in the event of a change in technical circumstances. There
            will be no transfer of personal data collected by the newsletter
            service to third parties. The subscription to our newsletter may be
            terminated by the data subject at any time. The consent to the
            storage of personal data, which the data subject has given for
            shipping the newsletter, may be revoked at any time. For the purpose
            of revocation of consent, a corresponding link is found in each
        ...
        <li>
          <strong className="mb-2">Newsletter-Tracking</strong>
          <p className="mb-4">
            The newsletter of orbal GmbH contains so-called tracking pixels. A
            ...
            tracking pixel, orbal GmbH may see if and when an e-mail was opened
            by a data subject, and which links in the e-mail were called up by
            data subjects.Such personal data collected in the tracking pixels
            ...
            personal data will be deleted by the controller. orbal GmbH
            automatically regards a withdrawal from the receipt of the
            newsletter as a revocation.
          </p>
        </li>
        <li>
          <strong className="mb-2">Contact possibility via the website</strong>
          <p className="mb-4">
            The website of orbal GmbH contains information that enables a quick
        ...
        <li>
          <strong className="mb-2">Rights of the data subject</strong>
          <p className="mb-4">
            a) Right of confirmation Each data subject shall have the right
            ...
            any employee of the controller. b) Right of access Each data subject
            ...
            any time, contact any employee of the controller. c) Right of
            ...
            or her. Taking into account the purposes of the processing, the data
            ...
            the controller. d) Right to erasure (right to be forgotten) Each
            ...
            one of the following grounds applies, as long as the processing is
            not necessary:The personal data are no longer necessary in relation
            ...
            GDPR. The personal data have been unlawfully processed. The personal
            data must be erased for compliance with a legal obligation in Union
            or Member State law to which the controller is subject. The personal
            data have been collected in relation to the offer of information
            society services referred to in Article 8(1) of the GDPR.If one of
            the aforementioned reasons applies, and a data subject wishes to
            request the erasure of personal data stored by orbal GmbH, he or she
            may, at any time, contact any employee of the controller. An
            employee of orbal GmbH shall promptly ensure that the erasure
            ...
            of, those personal data, as far as processing is not required. An
            employee of orbal GmbH will arrange the necessary measures in
            individual cases. e) Right of restriction of processing Each data
            subject shall have the right granted by the European legislator to
            obtain from the controller restriction of processing where one of
            the following applies:The accuracy of the personal data is contested
            by the data subject, for a period enabling the controller to verify
            the accuracy of the personal data. The processing is unlawful and
            the data subject opposes the erasure of the personal data and
            requests instead the restriction of their use instead. The
            ...
            establishment, exercise or defence of legal claims. The data subject
            has objected to processing pursuant to Article 21(1) of the GDPR
            ...
            orbal GmbH, he or she may at any time contact any employee of the
            controller. The employee of orbal GmbH will arrange the restriction
            of the processing. f) Right to data portability Each data subject
            shall have the right granted by the European legislator, to receive
            the personal data concerning him or her, which was provided to a
            ...
            the personal data have been provided, as long as the processing is
            based on consent pursuant to point (a) of Article 6(1) of the GDPR
            or point (a) of Article 9(2) of the GDPR, or on a contract pursuant
            to point (b) of Article 6(1) of the GDPR, and the processing is
            ...
            at any time contact any employee of orbal GmbH. f) Right to object
            ...
            orbal GmbH shall no longer process the personal data in the event of
            ...
            defence of legal claims.If orbal GmbH processes personal data for
            ...
            to orbal GmbH to the processing for direct marketing purposes,
            orbalGmbH will no longer process the personal data for these
            ...
            of personal data concerning him or her by orbal GmbH for scientific
            ...
            subject may contact any employee of orbal GmbH. In addition, the
            ...
            specifications. h) Automated individual decision-making, including
            ...
            data subject’s explicit consent.If the decision (1) is necessary for
            entering into, or the performance of, a contract between the data
            subject and a data controller, or (2) it is based on the data
            subject’s explicit consent, orbal GmbH shall implement suitable
            ...
            he or she may, at any time, contact any employee of orbal GmbH. i)
            ...
            consent, he or she may, at any time, contact any employee of orbal
            GmbH.
          </p>
        </li>
        <li>
          <strong className="mb-2">
            ...
            Analytics (with anonymisation function)
          </strong>
          <p className="mb-4">
            ...
            Analytics component is Google Ireland Limited, Gordon House, Barrow
            Street, Dublin, D04 E5W5, Ireland.For the web analytics through
            Google Analytics the controller uses the application “_gat.
            _anonymizeIp”. By means of this application the IP address of the
            Internet connection of the data subject is abridged by Google and
            ...
            is to analyze the traffic on our website. Google uses the collected
            data and information, inter alia, to evaluate the use of our website
            and to provide online reports, which show the activities on our
            websites, and to provide other services concerning the use of our
            Internet site for us.Google Analytics places a cookie on the
            information technology system of the data subject. The definition of
            cookies is explained above. With the setting of the cookie, Google
            is enabled to analyze the use of our website. With each call-up to
            one of the individual pages of this Internet site, which is operated
            by the controller and into which a Google Analytics component was
            ...
            and the settlement of commissions to Google. During the course of
            this technical procedure, the enterprise Google gains knowledge of
            ...
            settlements.The cookie is used to store personal information, such
            ...
            each visit to our Internet site, such personal data, including the
            IP address of the Internet access used by the data subject, will be
            ...
            procedure to third parties.The data subject may, as stated above,
            prevent the setting of cookies through our website at any time by
            ...
            subject. In addition, cookies already in use by Google Analytics may
            ...
            applicable data protection provisions of Google may be retrieved
        ...
        <li>
          <strong className="mb-2">
            Legal basis for the processing Art. 6(1) lit. a
          </strong>
          <p className="mb-4">
            GDPR serves as the legal basis for processing operations for which
            we obtain consent for a specific processing purpose. If the
            ...
            basis is used for processing operations which are not covered by any
            of the abovementioned legal grounds, if processing is necessary for
            the purposes of the legitimate interests pursued by our company or
