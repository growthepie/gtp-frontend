...
export interface Proposal {
  /** Proposal address */
  address: string;
  /** Matched rewards funds for the proposal, wei */
  value: string;
}
...
export interface EpochRewardsMerkleTreeLeaf {
  /** User account or proposal address */
  address: string;
  /** Assigned reward */
  amount: string;
}
...
export interface EpochAllocation {
  /** Donor address */
  donor: string;
  /** Funds allocated by donor for the proposal in WEI */
  amount: string;
  /** Proposal address */
  proposal: string;
}
...
export interface ProposalDonors {
  /** Donor address */
  address: string;
  /** Funds allocated by donor for the proposal in WEI */
  amount: string;
 ...
 */
export class OctantClient<
  SecurityDataType extends unknown,
> extends HttpClient<SecurityDataType> {
  allocations = {
    /**
     * @description Allocates user's funds to proposals
     *
     * @tags allocations
     * @name PostAllocation
     ...
     *
     * @tags allocations
     * @name GetProposalDonors
     * @request GET:/allocations/proposal/{proposal_address}/epoch/{epoch}
     */
    getProposalDonors: (
      proposalAddress: string,
      epoch: number,
      ...
      this.request<ProposalDonors, any>({
        path: `/allocations/proposal/${proposalAddress}/epoch/${epoch}`,
        method: "GET",
        format: "json",
        ...params,
      }),
  ...
  deposits = {
     ...
     */
    getUserEstimatedEffectiveDeposit: (
      userAddress: string,
      params: RequestParams = {},
    ) =>
