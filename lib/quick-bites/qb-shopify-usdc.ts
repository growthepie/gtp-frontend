...
const BaseCommercePaymentProtocol: QuickBiteData = createQuickBite({
  ...
  content: [
    ...
    JSON.stringify({
      ...
      description: "Toggle between daily, weekly, and monthly views of new and returning merchants",
      layout: "segmented",
      defaultIndex: 0,
      charts: [
        {
          toggleLabel: "Daily",
          type: "column",
          title: "Merchants Receiving USDC (Daily)",
        ...
        },
        {
          toggleLabel: "Weekly",
          type: "column",
          title: "Merchants Receiving USDC (Weekly)",
          subtitle: "The weekly number of new and returning merchants that received USDC",
          showXAsDate: true,
          dataAsJson: {
            meta: [{
              name: "New Merchants",
          ...
          height: 400,
          caption: "The weekly number of new and returning merchants that received USDC. Data aggregated by calendar week.",
          seeMetricURL: null
        },
        {
          toggleLabel: "Monthly",
          type: "column",
          title: "Merchants Receiving USDC (Monthly)",
          subtitle: "The monthly number of new and returning merchants that received USDC",
          showXAsDate: true,
          dataAsJson: {
            meta: [{
              name: "New Merchants",
          ...
          height: 400,
          caption: "The monthly number of new and returning merchants that received USDC. Data aggregated by month.",
          seeMetricURL: null
        }
      ],
    }),
    ...
    JSON.stringify({
      ...
      description: "Toggle between daily, weekly, and monthly views of new and returning customers",
      layout: "segmented",
      defaultIndex: 0,
      charts: [
        {
          toggleLabel: "Daily",
          type: "column",
          title: "Customers Paying in USDC (Daily)",
        ...
        },
        {
          toggleLabel: "Weekly",
          type: "column",
          title: "Customers Paying in USDC (Weekly)",
          subtitle: "The weekly number of new and returning customers that paid in USDC",
          showXAsDate: true,
          dataAsJson: {
            meta: [{
              name: "New Customers",
          ...
          height: 400,
          caption: "The weekly number of new and returning customers that paid in USDC. Data aggregated by calendar week.",
          seeMetricURL: null
        },
        {
          toggleLabel: "Monthly",
          type: "column",
          title: "Customers Paying in USDC (Monthly)",
          subtitle: "The monthly number of new and returning customers that paid in USDC",
          showXAsDate: true,
          dataAsJson: {
            meta: [{
              name: "New Customers",
          ...
          height: 400,
          caption: "The monthly number of new and returning customers that paid in USDC. Data aggregated by month.",
          seeMetricURL: null
        }
      ],
    }),
