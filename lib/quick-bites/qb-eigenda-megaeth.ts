...
const EigenDAMegaETH: QuickBiteData = {
  ...
  content: [
    ...
    "Ethereum blobs (EIP-4844) were a major step forward for L2 DA costs, but they were never designed for this scale. The entire Ethereum blob layer, shared across every rollup, currently maxes out at around 0.145 MiB/s. Even if MegaETH were the only L2 posting to Ethereum blobs, that capacity would still fall more than 10x short of what the stress test required. At peak, MegaETH was pushing around 2 MiB/s to EigenDA.",

    "```chart",
    JSON.stringify({
      type: "line",
      title: "Ethereum Blob Throughput: Usage vs. Target Capacity",
      subtitle: "MiB/s of blob data posted and target capacity since Dencun.",
      showXAsDate: true,
      dataAsJson: {
        meta: [
          {
            name: "Blob throughput",
            color: "#FFC300",
            type: "line",
            xIndex: 0,
            yIndex: 1,
    ...
    "EigenDA is a purpose-built DA layer on EigenLayer, designed to scale far beyond what Ethereum blobs can offer. At its current capacity of 100 MiB/s, EigenDA can already support up to **400,000 TPS** for MegaETH (assuming a conservative 4,000 TX/MiB). As EigenDA scales toward 1 GiB/s, the numbers become staggering. Millions of TPS become theoretically possible.",
    "The chart below shows EigenDA's max TPS ceiling over time versus where MegaETH actually sits today, and how much room remains to grow.",
